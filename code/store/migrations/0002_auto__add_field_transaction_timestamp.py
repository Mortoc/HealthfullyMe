...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('store_transaction', 'timestamp',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('store_transaction', 'timestamp')
    ...
    models = {
        ...
        'store.transaction': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
