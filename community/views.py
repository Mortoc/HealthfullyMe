...
from django.views.generic.simple import direct_to_template
from community.forms import CreateGreetingForm
...
def list_greetings(request):
    ...
    return direct_to_template(request, 'community/index.html',
                              {'greetings': greetings,
...
def create_new_user(request):
    ...
    return direct_to_template(request, 'community/user_create_form.html',
        {'form': form})
