...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HMUser.first_name'
        db.add_column(u'core_hmuser', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'HMUser.last_name'
        db.add_column(u'core_hmuser', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HMUser.first_name'
        db.delete_column(u'core_hmuser', 'first_name')

        # Deleting field 'HMUser.last_name'
        db.delete_column(u'core_hmuser', 'last_name')
