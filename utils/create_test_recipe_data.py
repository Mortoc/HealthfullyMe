...
def run():
    ...
    recipes_ingredient_1.name = u'Olive Oil'
    recipes_ingredient_1.pluralized_name = u'Olive Oil'
    recipes_ingredient_1 = save_or_locate(recipes_ingredient_1)

    recipes_ingredient_2 = Ingredient()
    recipes_ingredient_2.name = u'Lemon'
    recipes_ingredient_2.pluralized_name = u'Lemons'
    recipes_ingredient_2 = save_or_locate(recipes_ingredient_2)

    recipes_ingredient_3 = Ingredient()
    recipes_ingredient_3.name = u'Black Pepper'
    recipes_ingredient_3.pluralized_name = u'Black Pepper'
    recipes_ingredient_3 = save_or_locate(recipes_ingredient_3)

    recipes_ingredient_4 = Ingredient()
    recipes_ingredient_4.name = u'Garlic Salt'
    recipes_ingredient_4.pluralized_name = u'Garlic Salt'
    recipes_ingredient_4 = save_or_locate(recipes_ingredient_4)

    recipes_ingredient_5 = Ingredient()
    recipes_ingredient_5.name = u'Cayenne Pepper'
    recipes_ingredient_5.pluralized_name = u'Cayenne Pepper'
    recipes_ingredient_5 = save_or_locate(recipes_ingredient_5)

    recipes_ingredient_6 = Ingredient()
    recipes_ingredient_6.name = u'Paprika'
    recipes_ingredient_6.pluralized_name = u'Paprika'
    recipes_ingredient_6 = save_or_locate(recipes_ingredient_6)

    recipes_ingredient_7 = Ingredient()
    recipes_ingredient_7.name = u'Skinless Chicken Thigh'
    recipes_ingredient_7.pluralized_name = u'Skinless Chicken Thighs'
    recipes_ingredient_7 = save_or_locate(recipes_ingredient_7)

    recipes_ingredient_8 = Ingredient()
    recipes_ingredient_8.name = u'Hot Sauce'
    recipes_ingredient_8.pluralized_name = u'Hot Sauce'
    recipes_ingredient_8 = save_or_locate(recipes_ingredient_8)

    recipes_ingredient_9 = Ingredient()
    recipes_ingredient_9.name = u'Egg'
    recipes_ingredient_9.pluralized_name = u'Eggs'
    ...
    recipes_ingredient_10.pluralized_name = u'Large Whole Wheat Tortillas'
    recipes_ingredient_10 = save_or_locate(recipes_ingredient_10)

    recipes_ingredient_11 = Ingredient()
    recipes_ingredient_11.name = u'Mexican Blend Shredded Cheese'
    recipes_ingredient_11.pluralized_name = u'Mexican Blend Shredded Cheese'
    recipes_ingredient_11 = save_or_locate(recipes_ingredient_11)

    recipes_ingredient_12 = Ingredient()
    recipes_ingredient_12.name = u'Black Beans'
    recipes_ingredient_12.pluralized_name = u'Black Beans'
    recipes_ingredient_12 = save_or_locate(recipes_ingredient_12)

    recipes_ingredient_13 = Ingredient()
    recipes_ingredient_13.name = u'Salt & Pepper'
    recipes_ingredient_13.pluralized_name = u'Salt & Pepper'
    recipes_ingredient_13 = save_or_locate(recipes_ingredient_13)

    recipes_ingredient_14 = Ingredient()
    recipes_ingredient_14.name = u'Lime'
    recipes_ingredient_14.pluralized_name = u'Lime'
    recipes_ingredient_14 = save_or_locate(recipes_ingredient_14)

    recipes_ingredient_15 = Ingredient()
    recipes_ingredient_15.name = u'Cilantro'
    recipes_ingredient_15.pluralized_name = u'Cilantro'
    recipes_ingredient_15 = save_or_locate(recipes_ingredient_15)

    recipes_ingredient_16 = Ingredient()
    recipes_ingredient_16.name = u'Zucchini'
    recipes_ingredient_16.pluralized_name = u'Zucchinis'
    recipes_ingredient_16 = save_or_locate(recipes_ingredient_16)

    recipes_ingredient_17 = Ingredient()
    recipes_ingredient_17.name = u'Onion'
    recipes_ingredient_17.pluralized_name = u'Onions'
    recipes_ingredient_17 = save_or_locate(recipes_ingredient_17)

    recipes_ingredient_18 = Ingredient()
    recipes_ingredient_18.name = u'Jalape\xf1o'
    recipes_ingredient_18.pluralized_name = u'Jalape\xf1oes'
    recipes_ingredient_18 = save_or_locate(recipes_ingredient_18)

    recipes_ingredient_19 = Ingredient()
    recipes_ingredient_19.name = u'Diced Tomato'
    recipes_ingredient_19.pluralized_name = u'Diced Tomatoes'
    ...
    recipes_ingredientlisting_1.ingredient = recipes_ingredient_19
    recipes_ingredientlisting_1.notes = u''
    recipes_ingredientlisting_1.optional = False
    recipes_ingredientlisting_1.force_pluralized = False
    ...
    recipes_ingredientlisting_2.ingredient = recipes_ingredient_18
    recipes_ingredientlisting_2.notes = u''
    recipes_ingredientlisting_2.optional = False
    recipes_ingredientlisting_2.force_pluralized = False
    ...
    recipes_ingredientlisting_3.ingredient = recipes_ingredient_18
    recipes_ingredientlisting_3.notes = u'(minced)'
    recipes_ingredientlisting_3.optional = False
    recipes_ingredientlisting_3.force_pluralized = False
    ...
    recipes_ingredientlisting_4.ingredient = recipes_ingredient_17
    recipes_ingredientlisting_4.notes = u'(diced, for zucchini mixture)'
    recipes_ingredientlisting_4.optional = False
    recipes_ingredientlisting_4.force_pluralized = False
    ...
    recipes_ingredientlisting_5.ingredient = recipes_ingredient_17
    recipes_ingredientlisting_5.notes = u'(diced)'
    recipes_ingredientlisting_5.optional = False
    recipes_ingredientlisting_5.force_pluralized = False
    ...
    recipes_ingredientlisting_6.ingredient = recipes_ingredient_16
    recipes_ingredientlisting_6.notes = u'(diced)'
    recipes_ingredientlisting_6.optional = False
    recipes_ingredientlisting_6.force_pluralized = False
    ...
    recipes_ingredientlisting_7.ingredient = recipes_ingredient_15
    recipes_ingredientlisting_7.notes = u'(chopped and packed)'
    recipes_ingredientlisting_7.optional = False
    recipes_ingredientlisting_7.force_pluralized = False
    ...
    recipes_ingredientlisting_8.ingredient = recipes_ingredient_14
    recipes_ingredientlisting_8.notes = u'(juiced)'
    recipes_ingredientlisting_8.optional = False
    recipes_ingredientlisting_8.force_pluralized = False
    ...
    recipes_ingredientlisting_9.ingredient = recipes_ingredient_13
    recipes_ingredientlisting_9.notes = u'to taste'
    recipes_ingredientlisting_9.optional = False
    recipes_ingredientlisting_9.force_pluralized = False
    ...
    recipes_ingredientlisting_10.ingredient = recipes_ingredient_12
    recipes_ingredientlisting_10.notes = u'(drained)'
    recipes_ingredientlisting_10.optional = False
    recipes_ingredientlisting_10.force_pluralized = False
    ...
    recipes_ingredientlisting_11.ingredient = recipes_ingredient_11
    recipes_ingredientlisting_11.notes = u''
    recipes_ingredientlisting_11.optional = False
    recipes_ingredientlisting_11.force_pluralized = False
    ...
    recipes_ingredientlisting_12.force_pluralized = False
    ...
    recipes_ingredientlisting_13.ingredient = recipes_ingredient_9
    recipes_ingredientlisting_13.notes = u''
    recipes_ingredientlisting_13.optional = False
    recipes_ingredientlisting_13.force_pluralized = False
    ...
    recipes_ingredientlisting_14.ingredient = recipes_ingredient_8
    recipes_ingredientlisting_14.notes = u''
    recipes_ingredientlisting_14.optional = True
    recipes_ingredientlisting_14.force_pluralized = False
    ...
    recipes_ingredientlisting_15.ingredient = recipes_ingredient_7
    recipes_ingredientlisting_15.notes = u''
    recipes_ingredientlisting_15.optional = False
    recipes_ingredientlisting_15.force_pluralized = False
    ...
    recipes_ingredientlisting_16.ingredient = recipes_ingredient_6
    recipes_ingredientlisting_16.notes = u''
    recipes_ingredientlisting_16.optional = False
    recipes_ingredientlisting_16.force_pluralized = False
    ...
    recipes_ingredientlisting_17.ingredient = recipes_ingredient_5
    recipes_ingredientlisting_17.notes = u''
    recipes_ingredientlisting_17.optional = False
    recipes_ingredientlisting_17.force_pluralized = False
    ...
    recipes_ingredientlisting_18.ingredient = recipes_ingredient_4
    recipes_ingredientlisting_18.notes = u''
    recipes_ingredientlisting_18.optional = False
    recipes_ingredientlisting_18.force_pluralized = False
    ...
    recipes_ingredientlisting_19.ingredient = recipes_ingredient_3
    recipes_ingredientlisting_19.notes = u''
    recipes_ingredientlisting_19.optional = False
    recipes_ingredientlisting_19.force_pluralized = False
    ...
    recipes_ingredientlisting_20.ingredient = recipes_ingredient_2
    recipes_ingredientlisting_20.notes = u'(juiced)'
    recipes_ingredientlisting_20.optional = False
    recipes_ingredientlisting_20.force_pluralized = False
    ...
    recipes_ingredientlisting_21.ingredient = recipes_ingredient_1
    recipes_ingredientlisting_21.notes = u''
    recipes_ingredientlisting_21.optional = False
    recipes_ingredientlisting_21.force_pluralized = False
    ...
    recipes_ingredientlisting_22.ingredient = recipes_ingredient_9
    recipes_ingredientlisting_22.notes = u''
    recipes_ingredientlisting_22.optional = True
    recipes_ingredientlisting_22.force_pluralized = False
    ...
    recipes_ingredientlisting_23.ingredient = recipes_ingredient_14
    recipes_ingredientlisting_23.notes = u''
    recipes_ingredientlisting_23.optional = False
    recipes_ingredientlisting_23.force_pluralized = False
    ...
    recipes_recipe_1.created_date = datetime.datetime(2013, 4, 23, 18, 22, 11, tzinfo=<UTC>)
    recipes_recipe_1.serves = 2
    recipes_recipe_1.prep_time_hours = 0
    recipes_recipe_1.prep_time_minutes = 30
    recipes_recipe_1.refrigeration_life_days = 3
    recipes_recipe_1.featured = True
    recipes_recipe_1 = save_or_locate(recipes_recipe_1)

    recipes_recipe_1.images.add(recipes_recipeimg_1)
    recipes_recipe_1.images.add(recipes_recipeimg_2)
    recipes_recipe_1.images.add(recipes_recipeimg_3)
    recipes_recipe_1.images.add(recipes_recipeimg_4)
    recipes_recipe_1.images.add(recipes_recipeimg_5)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_1)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_3)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_4)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_5)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_6)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_7)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_8)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_9)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_10)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_11)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_12)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_13)
    recipes_recipe_1.ingredient_list.add(recipes_ingredientlisting_14)

    recipes_recipe_2 = Recipe()
    recipes_recipe_2.title = u'Spicy Lemon Paprika Chicken Thighs'
    recipes_recipe_2.instructions = u'<b>1.</b> Preheat the oven to <em>425\xb0 F</em><br/>\r\n<br/>\r\n2. Mix the paprika, cayenne, garlic salt, pepper, lemon juice and olive oil together in a big bowl<br/>\r\n<br/>\r\n3. Add the chicken thighs into the mixture and it marinate for a few hours. HOWEVER, this marinade actually tastes pretty good \r\neven without the wait :) I left it in the mixture for 5 minutes before throwing it into the oven<br/>\r\n<br/>\r\n4. Place the chicken on a baking sheet/pan and bake the pieces for 15 minutes, or until thoroughly cooked. This will depend on the size/thickness of your chicken<br/>\r\n<br/>\r\n5. Optional: Turn the oven into broiling mode if you want to make the chicken crispy<br/>'
    recipes_recipe_2.attribution = u'happychomp'
    recipes_recipe_2.attribution_link = u'http://www.happychomp.com/post/48660128323/how-to-make-spicy-lemon-paprika-chicken-thighs'
    ...
    recipes_recipe_2.created_date = datetime.datetime(2013, 4, 23, 18, 47, 53, tzinfo=<UTC>)
    recipes_recipe_2.serves = 2
    recipes_recipe_2.prep_time_hours = 0
    recipes_recipe_2.prep_time_minutes = 30
    recipes_recipe_2.refrigeration_life_days = 4
    recipes_recipe_2.featured = True
    recipes_recipe_2 = save_or_locate(recipes_recipe_2)

    recipes_recipe_2.images.add(recipes_recipeimg_6)
    recipes_recipe_2.images.add(recipes_recipeimg_7)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_15)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_16)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_17)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_18)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_19)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_20)
    recipes_recipe_2.ingredient_list.add(recipes_ingredientlisting_21)

    #Re-processing model: Recipe

    recipes_recipe_1.tags.add(  locate_object(Tag, "id", Tag, "id", 1, {'text': u'Mexican', 'id': 1} )  )

    recipes_recipe_2.tags.add(  locate_object(Tag, "id", Tag, "id", 2, {'text': u'Paleo', 'id': 2} )  )
