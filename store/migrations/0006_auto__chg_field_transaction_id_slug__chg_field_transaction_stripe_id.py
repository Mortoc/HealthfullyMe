...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'store_transaction', 'id_slug', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Transaction.stripe_id'
        db.alter_column(u'store_transaction', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.id_slug'
        db.alter_column(u'store_transaction', 'id_slug', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Transaction.stripe_id'
        db.alter_column(u'store_transaction', 'stripe_id', self.gf('django.db.models.fields.CharField')(max_length=64))
