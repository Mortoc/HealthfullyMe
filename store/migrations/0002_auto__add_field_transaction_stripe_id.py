...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.stripe_id'
        db.add_column(u'store_transaction', 'stripe_id',
                      self.gf('django.db.models.fields.CharField')(default='invalid', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.stripe_id'
        db.delete_column(u'store_transaction', 'stripe_id')
