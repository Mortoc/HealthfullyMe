...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComingSoonIdea.active'
        db.add_column('store_comingsoonidea', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComingSoonIdea.active'
        db.delete_column('store_comingsoonidea', 'active')
    ...
    models = {
        ...
        'store.transaction': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 26, 0, 0)'}),
