...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('store_card', 'address_line2', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Card.address_city'
        db.alter_column('store_card', 'address_city', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Card.expire_month'
        db.alter_column('store_card', 'expire_month', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Card.address_country'
        db.alter_column('store_card', 'address_country', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Card.address_state'
        db.alter_column('store_card', 'address_state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Card.expire_year'
        db.alter_column('store_card', 'expire_year', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Card.address_line2'
        db.alter_column('store_card', 'address_line2', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Card.address_city'
        db.alter_column('store_card', 'address_city', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'Card.expire_month'
        db.alter_column('store_card', 'expire_month', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'Card.address_country'
        db.alter_column('store_card', 'address_country', self.gf('django.db.models.fields.CharField')(default='', max_length=64))

        # Changing field 'Card.address_state'
        db.alter_column('store_card', 'address_state', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'Card.expire_year'
        db.alter_column('store_card', 'expire_year', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'store.card': {
            ...
            'address_city': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'address_country': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True'}),
            'address_line1': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'address_line2': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'address_state': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'}),
