...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.completed_order_copy'
        db.add_column(u'store_offer', 'completed_order_copy',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.completed_order_copy'
        db.delete_column(u'store_offer', 'completed_order_copy')
    ...
    models = {
        ...
        u'store.offer': {
            ...
            'completed_order_copy': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
