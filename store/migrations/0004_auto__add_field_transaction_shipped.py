...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.shipped'
        db.add_column(u'store_transaction', 'shipped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.shipped'
        db.delete_column(u'store_transaction', 'shipped')
    ...
    models = {
        ...
        u'store.transaction': {
            ...
            'shipping_tracking_data': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '255'}),
