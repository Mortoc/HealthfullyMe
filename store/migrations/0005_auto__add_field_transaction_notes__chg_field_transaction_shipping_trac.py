...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.notes'
        db.add_column(u'store_transaction', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


        # Changing field 'Transaction.shipping_tracking_data'
        db.alter_column(u'store_transaction', 'shipping_tracking_data', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Transaction.notes'
        db.delete_column(u'store_transaction', 'notes')


        # Changing field 'Transaction.shipping_tracking_data'
        db.alter_column(u'store_transaction', 'shipping_tracking_data', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'store.transaction': {
            ...
            'stripe_id': ('django.db.models.fields.CharField', [], {'default': "'invalid'", 'max_length': '64'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.HMUser']"})
        }
    }
