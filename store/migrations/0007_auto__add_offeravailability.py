...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OfferAvailability'
        db.create_table(u'store_offeravailability', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('purchases', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('time_value', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('time_peroid', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'store', ['OfferAvailability'])

        # Adding M2M table for field availability on 'Offer'
        db.create_table(u'store_offer_availability', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offer', models.ForeignKey(orm[u'store.offer'], null=False)),
            ('offeravailability', models.ForeignKey(orm[u'store.offeravailability'], null=False))
        ))
        db.create_unique(u'store_offer_availability', ['offer_id', 'offeravailability_id'])


    def backwards(self, orm):
        # Deleting model 'OfferAvailability'
        db.delete_table(u'store_offeravailability')

        # Removing M2M table for field availability on 'Offer'
        db.delete_table('store_offer_availability')
    ...
    models = {
        ...
        u'store.offer': {
            ...
            'availability': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['store.OfferAvailability']", 'symmetrical': 'False'}),
