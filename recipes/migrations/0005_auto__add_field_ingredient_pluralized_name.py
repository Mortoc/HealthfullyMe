...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ingredient.pluralized_name'
        db.add_column(u'recipes_ingredient', 'pluralized_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ingredient.pluralized_name'
        db.delete_column(u'recipes_ingredient', 'pluralized_name')
