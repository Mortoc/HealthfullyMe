...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IngredientListing.notes'
        db.add_column(u'recipes_ingredientlisting', 'notes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IngredientListing.notes'
        db.delete_column(u'recipes_ingredientlisting', 'notes')
