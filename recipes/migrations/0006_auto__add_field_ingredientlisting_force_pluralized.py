...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IngredientListing.force_pluralized'
        db.add_column(u'recipes_ingredientlisting', 'force_pluralized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IngredientListing.force_pluralized'
        db.delete_column(u'recipes_ingredientlisting', 'force_pluralized')
