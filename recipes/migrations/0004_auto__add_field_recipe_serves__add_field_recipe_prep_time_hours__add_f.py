...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.serves'
        db.add_column(u'recipes_recipe', 'serves',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Recipe.prep_time_hours'
        db.add_column(u'recipes_recipe', 'prep_time_hours',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Recipe.prep_time_minutes'
        db.add_column(u'recipes_recipe', 'prep_time_minutes',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=20),
                      keep_default=False)

        # Adding field 'Recipe.refrigeration_life_days'
        db.add_column(u'recipes_recipe', 'refrigeration_life_days',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.serves'
        db.delete_column(u'recipes_recipe', 'serves')

        # Deleting field 'Recipe.prep_time_hours'
        db.delete_column(u'recipes_recipe', 'prep_time_hours')

        # Deleting field 'Recipe.prep_time_minutes'
        db.delete_column(u'recipes_recipe', 'prep_time_minutes')

        # Deleting field 'Recipe.refrigeration_life_days'
        db.delete_column(u'recipes_recipe', 'refrigeration_life_days')
