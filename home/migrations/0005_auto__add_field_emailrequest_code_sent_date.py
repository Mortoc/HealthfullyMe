...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailRequest.code_sent_date'
        db.add_column(u'home_emailrequest', 'code_sent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailRequest.code_sent_date'
        db.delete_column(u'home_emailrequest', 'code_sent_date')
    ...
    models = {
        ...
        u'home.emailrequest': {
            ...
            'code_sent_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
